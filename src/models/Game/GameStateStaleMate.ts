...
export class GameStateStaleMate {
  private kingCanMove(board: Board, color: Color): boolean {
  ...
  private pieceCanMove(board: Board, color: Color): boolean {
  ...
  public isStaleMate(board: Board, color: Color): Color | null {
